...
import com.microservice.orderservice.external.PaymentApiClient;
import com.microservice.orderservice.external.ProductApiClient;
...
public class OrderServiceImpl implements OrderService {
    ...
    public long placeOrder(OrderRequest orderRequest) {
        ...
        productApiClient.reduceQuantity(orderRequest.getProductId(), orderRequest.getQuantity());
        ...
        try {
            paymentApiClient.doPayment(paymentRequest);
    ...
    public OrderResponse getOrderDetails(long orderId) {
        ...
        ResponseEntity<ProductResponse> productResponseEntity = productApiClient.getProductById(order.getProductId());
        ...
        ResponseEntity<PaymentResponse> paymentResponseEntity = paymentApiClient.getPaymentDetailsByOrderId(order.getId());
